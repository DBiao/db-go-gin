...
func (c *greetClient) Hello(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
...
func (UnimplementedGreetServer) Hello(context.Context, *GreetRequest) (*GreetResponse, error) {
...
func _Greet_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServer).Hello(ctx, req.(*GreetRequest))
	}
